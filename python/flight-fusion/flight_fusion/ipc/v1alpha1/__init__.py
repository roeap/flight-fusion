...
# sources: flight_fusion/ipc/v1alpha1/common.proto, flight_fusion/ipc/v1alpha1/delta.proto, flight_fusion/ipc/v1alpha1/environment.proto, flight_fusion/ipc/v1alpha1/flight.proto, flight_fusion/ipc/v1alpha1/message.proto, flight_fusion/ipc/v1alpha1/metadata.proto, flight_fusion/ipc/v1alpha1/signals.proto
...
@dataclass(eq=False, repr=False)
class ServiceConnection(betterproto.Message):
    host: str = betterproto.string_field(1)
    port: int = betterproto.int32_field(2)


@dataclass(eq=False, repr=False)
class EnvironmentInfo(betterproto.Message):
    server_version: str = betterproto.string_field(1)
    artifact_service: "ServiceConnection" = betterproto.message_field(2)
    model_serving: "ServiceConnection" = betterproto.message_field(3)
    data_sets: "ServiceConnection" = betterproto.message_field(4)
    pipelines_ui: "ServiceConnection" = betterproto.message_field(5)
    models_ui: "ServiceConnection" = betterproto.message_field(6)
...
class Signal(betterproto.Message):
    ...
    nullable: bool = betterproto.bool_field(5)
    traits: List["SignalTrait"] = betterproto.message_field(10)
    metadata: Dict[str, str] = betterproto.map_field(11, betterproto.TYPE_STRING, betterproto.TYPE_STRING)
