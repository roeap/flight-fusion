...
_DELTAREFERENCE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="location",
            full_name="flight_fusion_ipc.DeltaReference.location",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_LISTINGREFERENCE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="path",
            full_name="flight_fusion_ipc.ListingReference.path",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_FILEREFERENCE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="path",
            full_name="flight_fusion_ipc.FileReference.path",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
...
_TABLEREFERENCE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="delta",
            full_name="flight_fusion_ipc.TableReference.delta",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="listing",
            full_name="flight_fusion_ipc.TableReference.listing",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="filse",
            full_name="flight_fusion_ipc.TableReference.filse",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="table",
            full_name="flight_fusion_ipc.TableReference.table",
            index=0,
            containing_type=None,
            create_key=_descriptor._internal_create_key,
            fields=[],
...
_TABLEREFERENCE.oneofs_by_name["table"].fields.append(_TABLEREFERENCE.fields_by_name["delta"])
_TABLEREFERENCE.fields_by_name["delta"].containing_oneof = _TABLEREFERENCE.oneofs_by_name["table"]
_TABLEREFERENCE.oneofs_by_name["table"].fields.append(_TABLEREFERENCE.fields_by_name["listing"])
_TABLEREFERENCE.fields_by_name["listing"].containing_oneof = _TABLEREFERENCE.oneofs_by_name["table"]
_TABLEREFERENCE.oneofs_by_name["table"].fields.append(_TABLEREFERENCE.fields_by_name["filse"])
...
DeltaReference = _reflection.GeneratedProtocolMessageType(
    "DeltaReference",
    (_message.Message,),
    {
...
ListingReference = _reflection.GeneratedProtocolMessageType(
    "ListingReference",
    (_message.Message,),
    {
