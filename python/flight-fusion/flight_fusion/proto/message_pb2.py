...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        actions__pb2.DESCRIPTOR,
        tickets__pb2.DESCRIPTOR,
    ],
)
...
_FLIGHTACTIONREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="register",
            full_name="flight_fusion_ipc.FlightActionRequest.register",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="drop",
            full_name="flight_fusion_ipc.FlightActionRequest.drop",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="action",
            full_name="flight_fusion_ipc.FlightActionRequest.action",
            index=0,
            containing_type=None,
            create_key=_descriptor._internal_create_key,
            fields=[],
...
_FLIGHTDOGETREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="sql",
            full_name="flight_fusion_ipc.FlightDoGetRequest.sql",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="kql",
            full_name="flight_fusion_ipc.FlightDoGetRequest.kql",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="operation",
            full_name="flight_fusion_ipc.FlightDoGetRequest.operation",
            index=0,
            containing_type=None,
            create_key=_descriptor._internal_create_key,
            fields=[],
...
_FLIGHTDOPUTREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="memory",
            full_name="flight_fusion_ipc.FlightDoPutRequest.memory",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="remote",
            full_name="flight_fusion_ipc.FlightDoPutRequest.remote",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
        ...
        _descriptor.FieldDescriptor(
            name="delta",
            full_name="flight_fusion_ipc.FlightDoPutRequest.delta",
            index=2,
            number=3,
            type=11,
            cpp_type=10,
    ...
    oneofs=[
        _descriptor.OneofDescriptor(
            name="operation",
            full_name="flight_fusion_ipc.FlightDoPutRequest.operation",
            index=0,
            containing_type=None,
            create_key=_descriptor._internal_create_key,
            fields=[],
...
FlightActionRequest = _reflection.GeneratedProtocolMessageType(
    "FlightActionRequest",
    (_message.Message,),
    {
...
FlightDoGetRequest = _reflection.GeneratedProtocolMessageType(
    "FlightDoGetRequest",
    (_message.Message,),
    {
...
FlightDoPutRequest = _reflection.GeneratedProtocolMessageType(
    "FlightDoPutRequest",
    (_message.Message,),
    {
