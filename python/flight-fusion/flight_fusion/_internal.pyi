...
class FusionClient:
    ...
    def read_table(self, command: bytes) -> List[pa.RecordBatch]:
        ...
        """
        ...
    def list_sources(self) -> List[bytes]: ...
    ...
    def set_metadata(self, command: bytes) -> None: ...
    def get_schema(self, command: bytes) -> pa.Schema: ...
    def execute_query(self, command: bytes) -> List[pa.RecordBatch]: ...
