from dagster import HookExecutionResult, event_list_hook
...
def _cleanup_on_success(context):
    ...
    """
    last_solid_name = (
        context._step_execution_context.pipeline_def.solids_in_topological_order[  # pylint: disable=protected-access
            -1
        ].name
    )
