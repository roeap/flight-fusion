...
class Annotations(BaseModel):
    ...
    class Config:
        schema_extra = {
            "$ref": create_definition_ref("io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta/properties/annotations")
        }
...
class Labels(BaseModel):
    class Config:
        schema_extra = {
            "$ref": create_definition_ref("io.k8s.apimachinery.pkg.apis.meta.v1.ObjectMeta/properties/labels")
        }
...
class NodeSelector(BaseModel):
    ...
    class Config:
        schema_extra = {"$ref": create_definition_ref("io.k8s.api.core.v1.PodSpec/properties/nodeSelector")}
...
class Tolerations(BaseModel):
    ...
    class Config:
        schema_extra = {"$ref": create_definition_ref("io.k8s.api.core.v1.PodSpec/properties/tolerations")}
