...
This example has been adopted from the [hacker news example](https://github.com/dagster-io/dagster/tree/master/examples/hacker_news)
from the core dagster repository.
